...
if len(x_ar) == len(x_ni):
    x = range(len(x_ar))
    plt.plot(x, x_ar_diff, color = 'r', label = 'arkit error with gt')
    plt.plot(x, x_ni_diff, color = 'b', label = 'ni error with gt')
plt.xlabel("frame")
plt.ylabel("x diff")
plt.legend()
plt.show()
...
if len(y_ar) == len(y_ni):
    y = range(len(y_ar))
    plt.plot(y, y_ar_diff, color = 'r', label = 'arkit error with gt')
    plt.plot(y, y_ni_diff, color = 'b', label = 'ni error with gt')
plt.xlabel("frame")
plt.ylabel("y diff")
plt.legend()
plt.show()
...
if len(z_ar) == len(z_ni):
    z = range(len(z_ar))
    plt.plot(z, z_ar_diff, color = 'r', label = 'arkit error with gt')
    plt.plot(z, z_ni_diff, color = 'b', label = 'ni error with gt')
plt.xlabel("frame")
plt.ylabel("z diff")
plt.legend()
plt.show()