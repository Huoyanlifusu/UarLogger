...
class CMManager: CMMotionManager {
    ...
    var logStringGyro = NSMutableString(string: "")
    var logStringAcce = NSMutableString(string: "")
    var logStringMagn = NSMutableString(string: "")
    var logStringMotion = NSMutableString(string: "")
